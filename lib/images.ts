...
export const images = {
  ...
  greenHero: "/hero-bg.png", // hero background
  ...
  step1Freezer: "/step1-freezer.png", // frozen berries
  ...
  productShot: "/product-shot.png", // product shot
  productPouch: "/pouch.png", // product pouch

  // ── Simplii Texture (/simplii-texture) ─────────────────
  textureHero: "/texture-hero.jpg", // plated salmon dish
